...
class _ScheduleListState extends State<ScheduleList> {
  ...
  Future<void> fetchSchedule() async {
    ...
    final url = 'https://dotlive-schedule.appspot.com?q=${jst.year}-${jst.month}-${jst.day}';
    _version += 1;
    final temp = _version;
  ...
  Widget _createCard(ScheduleEntry entry) {
    ...
    final title = '${d.hour.toString().padLeft(2, '0')}:${d.minute.toString().padLeft(2, '0')}~ ${entry.actorName}';
